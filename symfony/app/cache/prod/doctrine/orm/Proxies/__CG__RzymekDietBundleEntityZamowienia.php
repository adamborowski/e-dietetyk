 ...
 */
class Zamowienia extends \Rzymek\DietBundle\Entity\Zamowienia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'zamowienieId', 'data', 'login');
        }
    ...
    public function getZamowienieId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getZamowienieId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getZamowienieId', array());

        return parent::getZamowienieId();
    }
