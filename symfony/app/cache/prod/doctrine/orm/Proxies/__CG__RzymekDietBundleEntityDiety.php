 ...
 */
class Diety extends \Rzymek\DietBundle\Entity\Diety implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'dietaId', 'data', 'login');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Diety $proxy) {
    ...
    public function getDietaId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getDietaId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDietaId', array());

        return parent::getDietaId();
    }
