                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                }
                                {
                                    ...
                                    items: [
                                        @createFatControls('pępek', app.url('e-dietetyk/images/measurements/man_pepek.png'),
                                            'man_slider_pepek',
                                            0, 100)
                                        @createFatControls('udo', app.url('e-dietetyk/images/measurements/man_udo.png'), 'man_slider_udo',
                                            0,
                                            150)
                                ...
                                }
                                {
                                    ...
                                    items: [
                                        ...
                                        @createFatControls('udo', app.url('e-dietetyk/images/measurements/woman_udo.png'),
                                            'woman_slider_udo',
                                            0, 90)
